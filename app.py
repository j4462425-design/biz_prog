...
# 프로젝트 루트 디렉토리를 파이썬 경로에 추가하여 
# static linter(Pyrefly 등)와 runtime 실행이 모두 'last.utils'로 동작할 수 있게 함
parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
if parent_dir not in sys.path:
    sys.path.insert(0, parent_dir)

from last.utils import (total_sales, average_sales, to_grade, grade_to_incentive,
...
# 상단 배너 이미지 (banner.png) 경로를 파일 기준 상대경로로 안전하게 지정
